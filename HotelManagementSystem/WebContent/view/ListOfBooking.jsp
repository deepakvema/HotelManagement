...
<div align="center">
    ...
    <body style="font-family:Verdana;color:#aaaaaa;">
        <div style="background-color:#FFFFFF; padding:15px;text-align:center;">
            <a href="Home.jsp"><img alt="img is not loaded" src="apple-icon-144x144.png" style="float: left;"></a> <a href="Home.jsp"><button style="float:right; width:100px; ">Logout</button></a>
            <h1>GoHotels</h1>
	...
	Ads
            ...
            <div class="main">
                <form class="modal-content animate" method="post" action="getBookingsList" style="border: none;">
                   		 
                   		 Select date:<input type="date" required name="date" >
